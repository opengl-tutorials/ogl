...
language: uk
---
Цей сайт присвячений **туторіалу** по **OpenGL 3.3** та більш пізніших!

Вихідні коди доступні за [посиланням]({{ site.baseurl }}/uk/download).

Якщо у Вас виникнуть будь-які питання, коментарі, баги чи ще щось, пишіть нам <a href="mailto:contact@opengl-tutorial.org">contact@opengl-tutorial.org</a>, та не забувайте спочатку заглянути до [FAQ]({{ site.baseurl }}/miscellaneous/faq/)!


Ми раді доповненням до нашого проекту, особливо [перекладам]({{site.baseurl}}/uk/miscellaneous/contribute/translation/) !

Якщо Вам подобається наша робота, не бійтесь її розповсюджувати світом!
...
<div class="home">
  ...
  <p class="rss-subscribe">підписатись <a href="{{ "/feed.xml" | prepend: site.baseurl }}">via RSS</a></p>
