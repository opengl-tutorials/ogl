...
IF EXIST .\examples\heightmap.exe         del .\examples\heightmap.exe
...
IF EXIST .\examples\heightmap.obj         del .\examples\heightmap.obj
...
IF EXIST .\examples\heightmap.tds         del .\examples\heightmap.tds
