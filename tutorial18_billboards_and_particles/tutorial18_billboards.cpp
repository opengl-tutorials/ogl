...
int main( void )
{
	...
	glfwSetWindowTitle( "Tutorial 18 - Billboards" );
	...
	GLuint cubeVertexPosition_modelspaceID = glGetAttribLocation(programID, "vertexPosition_modelspace");
	GLuint cubeVertexColorID = glGetAttribLocation(programID, "vertexColor");
