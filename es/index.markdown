...
Sientete libre de contactarnos si tienes alguna pregunta, anotación, bug para reportar u otros a : <a href="mailto:contact@opengl-tutorial.org">contact@opengl-tutorial.org</a>.

Si te gusta nuestro trabajo no dude en compartirlo !
...
<div class="home">
  ...
  <p class="rss-subscribe">Suscribete <a href="{{ "/feed.xml" | prepend: site.baseurl }}">via RSS</a></p>
