...
language: hu
---
A honlap **OpenGL 3.3** és a feletti verziók használatához nyújt **útmutatót** !

A teljes forráskód elérhető [itt]({{ site.baseurl }}/download).

Ha bármi kérdésed, észrevételed van vagy találtál egy hibát az oldalon, nyugodtan írj az alábbi címre : <a href="mailto:contact@opengl-tutorial.org">contact@opengl-tutorial.org</a>, de ne felejtsd el elolvasni a [GYIK]({{ site.baseurl }}/miscellaneous/faq/)-et előtte !

Az oldal fejlesztésével kapcsolatos segítséget szívesen fogadjuk, különösen a [fordításban]({{site.baseurl}}/miscellaneous/contribute/translation/) !

Ha tetszik a munkánk, akkor bátran terjessz minket !
...
<div class="home">
  ...
  <p class="rss-subscribe"><a href="{{ "/feed.xml" | prepend: site.baseurl }}">RSS hírcsatorna</a></p>
